...
const PROCESS_FORMULAS = {
  ...
  modern: {
    ...
    formulas: [
      ...
      {
        name: 'Modelo de Estado Espacial',
...
export default function CzochralskiPanel() {
  const [selectedComponent, setSelectedComponent] = useState(null);
  const [activeFormulaTab, setActiveFormulaTab] = useState('transport');
  const [showModal, setShowModal] = useState(false);

  useEffect(() => {
    log_event('START', 'Painel Czochralski iniciado');
    return () => log_event('END', 'Painel Czochralski encerrado');
  }, []);
  ...
  return (
    <div className="czochralski-panel">
